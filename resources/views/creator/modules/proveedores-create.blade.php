...
<head>
    ...
    <title>Nuevo proveedor | CrowdUp Creador</title>
...
<body class="bg-zinc-950 text-zinc-100 font-sans min-h-screen">
    ...
    <header class="sticky top-0 z-30 border-b border-white/10 bg-zinc-950/80 backdrop-blur-xl">
        <div class="mx-auto flex h-16 max-w-5xl items-center justify-between px-4 sm:px-6 lg:px-8">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-lg font-semibold text-white">Agregar proveedor</h1>
            </div>
    ...
    <main class="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8 space-y-6">
        <section class="rounded-3xl border border-white/10 bg-zinc-900/70 p-8 shadow-2xl ring-1 ring-emerald-500/10">
            ...
            <p class="mt-2 text-sm text-zinc-400">Registra los datos y asócialo a un proyecto si aplica.</p>
            ...
            <form method="POST" action="{{ route('creador.proveedores.store') }}" class="mt-6 grid gap-4 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <input name="nombre_proveedor" required class="mt-1 w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white focus:border-emerald-400 focus:ring-emerald-400" placeholder="Ej: Acme Logistica">
                </div>
                <div>
                    <label class="text-sm text-zinc-300">Especialidad</label>
                    <input name="especialidad" class="mt-1 w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white focus:border-emerald-400 focus:ring-emerald-400" placeholder="Logistica, materiales, tech...">
                </div>
                <div>
                    <label class="text-sm text-zinc-300">Contacto</label>
                    <input name="info_contacto" class="mt-1 w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white focus:border-emerald-400 focus:ring-emerald-400" placeholder="correo@proveedor.com / +57 300...">
                </div>
                <div class="md:col-span-2">
