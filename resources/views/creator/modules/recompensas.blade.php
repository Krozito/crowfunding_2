...
<body class="bg-zinc-950 text-zinc-100 font-sans min-h-screen">
    ...
    <main class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <section class="rounded-3xl border border-white/10 bg-zinc-900/70 p-8 shadow-2xl">
            <p class="text-xs font-semibold uppercase tracking-[0.3em] text-zinc-400">Engagement</p>
            <h2 class="mt-2 text-2xl font-bold text-white">Niveles de recompensa</h2>
            <p class="mt-2 text-sm text-zinc-400">
                Define tiers, beneficios y entregas ligadas a montos de aportación (HU5, HU10).
            </p>
            <div class="mt-6 rounded-2xl border border-dashed border-white/15 bg-white/5 p-6 text-sm text-zinc-300">
                Próximamente: CRUD de recompensas, stock, fechas estimadas y comunicación a colaboradores.
            </div>
        </section>
    </main>
</body>
