...
<body class="bg-zinc-950 text-zinc-100 font-sans min-h-screen">
    ...
    <main class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <section class="rounded-3xl border border-white/10 bg-zinc-900/70 p-8 shadow-2xl">
            <p class="text-xs font-semibold uppercase tracking-[0.3em] text-zinc-400">Finanzas</p>
            <h2 class="mt-2 text-2xl font-bold text-white">Escrow, desembolsos y pagos</h2>
            <p class="mt-2 text-sm text-zinc-400">
                Controla solicitudes de desembolso, pagos a proveedores y adjunta comprobantes (HU12-HU15, HU13-HU14).
            </p>
            <div class="mt-6 rounded-2xl border border-dashed border-white/15 bg-white/5 p-6 text-sm text-zinc-300">
                Próximamente: flujo de solicitud de desembolsos, seguimiento de estado y evidencia de gastos.
            </div>
        </section>
    </main>
</body>
